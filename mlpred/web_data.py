...
def near_cafe_db(long, lat):
    ...
    df_main = pd.read_csv('static/after/cafe_data.csv', encoding='cp949')
...
def near_subway_db(long, lat):
    ...
    df_traffic = pd.read_csv('static/after/traffic_data.csv', encoding='cp949')
...
def near_culture_db(long, lat):
    ...
    df_culture = pd.read_csv('static/after/culture_data.csv', encoding='cp949')
...
def area_cafe_db(long, lat):
    ...
    # area_avgCustomer
    # area_count
    df_area = pd.read_csv('static/after/area_data.csv', encoding='cp949')
